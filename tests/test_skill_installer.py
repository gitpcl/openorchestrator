...
class TestSkillInstaller:
    ...
    def test_install_creates_symlink_by_default(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_install_with_symlink_false_creates_copy(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_install_with_copy_true_creates_file_copy(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_install_with_force_overwrites_existing_copy(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_install_creates_parent_directories(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_install_raises_error_on_permission_denied(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_uninstall_removes_skill_file(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_uninstall_removes_empty_directory(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_uninstall_keeps_directory_with_other_files(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_uninstall_returns_false_if_not_installed(self, skill_installer: SkillInstaller) -> None:
    ...
    def test_uninstall_raises_error_on_permission_denied(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_is_installed_returns_true_when_skill_exists(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_is_installed_returns_false_when_skill_missing(self, skill_installer: SkillInstaller) -> None:
    ...
    def test_is_installed_returns_true_for_broken_symlink(self, skill_installer: SkillInstaller, temp_directory: Path) -> None:
    ...
    def test_is_symlink_correctly_identifies_symlinks(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_is_symlink_returns_false_for_copied_files(self, skill_installer: SkillInstaller) -> None:
    ...
    def test_is_symlink_returns_false_when_not_installed(self, skill_installer: SkillInstaller) -> None:
    ...
    def test_is_up_to_date_returns_false_when_not_installed(self, skill_installer: SkillInstaller) -> None:
    ...
    def test_get_source_path_finds_skill_in_package(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_get_source_path_raises_error_if_skill_missing(self, skill_installer: SkillInstaller) -> None:
    ...
    def test_get_target_path_returns_correct_path(self, skill_installer: SkillInstaller) -> None:
    ...
    def test_get_symlink_target_returns_path_for_symlinks(self, skill_installer: SkillInstaller, skills_source_dir: Path) -> None:
    ...
    def test_get_symlink_target_returns_none_for_copies(self, skill_installer: SkillInstaller) -> None:
    ...
    def test_get_symlink_target_returns_none_when_not_installed(self, skill_installer: SkillInstaller) -> None:
...
class TestSkillCLI:
    ...
    @patch("open_orchestrator.core.skill_installer.SkillInstaller")
    def test_skill_install_handles_skill_not_found_error(self, mock_installer_class: MagicMock, cli_runner: CliRunner) -> None:
    ...
    @patch("open_orchestrator.core.skill_installer.SkillInstaller")
    def test_skill_uninstall_shows_message_if_not_installed(self, mock_installer_class: MagicMock, cli_runner: CliRunner) -> None:
    ...
    @patch("open_orchestrator.core.skill_installer.SkillInstaller")
    def test_skill_uninstall_handles_errors(self, mock_installer_class: MagicMock, cli_runner: CliRunner) -> None:
    ...
    @patch("open_orchestrator.core.skill_installer.SkillInstaller")
    def test_skill_status_shows_not_installed(self, mock_installer_class: MagicMock, cli_runner: CliRunner) -> None:
